    ...
    $.ajax({
      ...
      success: function (response) {
          ...
          $.each(response, function (indexInArray, valueOfElement) { 
               ...
               '<td class="text-center">'+ valueOfElement.group_name+'</td>';
               
               table += '<td class="text-center"><span style="color:darkblue;" data-id="'+ valueOfElement.id+'"class="icon ri-edit-2-fill group-edit"></span> &nbsp; &nbsp;<span style="color:red;" data-id="'+ valueOfElement.id+'" class="icon ri-chat-delete-fill group-delete"></span> </td>'
               '</tr>';
          });
