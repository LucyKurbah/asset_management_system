    ...
    success: function (response) {
      console.log(response);
        ...
        $.each(response, function (indexInArray, valueOfElement) { 
             ...
             table += '<td class="text-center"><span style="color:darkblue;" data-id="'+ valueOfElement.id+'"class="icon ri-edit-2-fill user-edit"></span> &nbsp; &nbsp;<span style="color:red;" data-id="'+ valueOfElement.id+'" class="icon ri-chat-delete-fill user-delete"></span> </td>'
             '</tr>';
        });
          $(".admin-table tbody").append(table);
    ...
    $('#admin-form').on('submit', function(e) {
        ...
        $.ajax({
          ...
          success:function(data){
            console.log(data);
            if(data['flag']=='Y'){ //Succcess for creation of new Admin
              $(".table_msg1").show();
            ...
            else if(data['flag']=='YY'){ //Succcess for editing an Admin
              $(".table_msg5").show();
            ...
            else if(data['flag']=='N'){  //Error while creation of new Admin
              $(".table_msg2").show();
            ...
            else if(data['flag']=='NN'){ //Error while editing an Admin
              $(".table_msg6").show();
