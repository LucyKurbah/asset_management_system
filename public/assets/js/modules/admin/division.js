    ...
    $.ajax({
      ...
      success: function (response) {
          ...
          $.each(response, function (indexInArray, valueOfElement) { 
               ...
               '<td class="text-center">'+ valueOfElement.division_name+'</td>';
               
               table += '<td class="text-center"><span style="color:darkblue;" data-id="'+ valueOfElement.id+'"class="icon ri-edit-2-fill division-edit"></span> &nbsp; &nbsp;<span style="color:red;" data-id="'+ valueOfElement.id+'" class="icon ri-chat-delete-fill division-delete"></span> </td>'
               '</tr>';
          });
      ...
      $(document).on('click','.division-delete',function (e) { 
          e.preventDefault();
          var id = $(this).data('id');
          $.ajax({
            type: "POST",
            url: "/division-delete-data",
            data: {id},
            cache:false,
            success:function(data){
              if(data['flag']=='Y'){
