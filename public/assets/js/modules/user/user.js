  ...
  $.ajax({
    ...
    success: function (response) {
        ...
        $.each(response, function (indexInArray, valueOfElement) { 
             table += '<tr>'+
             '<td class="text-center">'+ valueOfElement.emp_code + '</td>'+
      ...
      $(document).on('click','.user-edit',function (e) { 
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            $("#division option[value='" + data[0]['division'] + "']").prop('selected', true);
            $("#group option[value='" + data[0]['group'] + "']").prop('selected', true);
