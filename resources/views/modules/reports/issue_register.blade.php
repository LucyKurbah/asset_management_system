              ...
              <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="text-center" scope="col" width="10%">Date of Issue</th>
                    <th class="text-center" scope="col" width="20%">Name of Department Concerned</th>
                    <th class="text-center" scope="col" width="8%">Size (in cm*col)</th>
                    <th class="text-center" scope="col" width="8%">Subject</th>
                    <th class="text-center" scope="col" width="20%">Ref. No & Date</th>
                    <th class="text-center" scope="col" width="8%">Positively on</th>
                    <th class="text-center" scope="col" width="8%">No. of Insertion</th>
                    <th class="text-center" scope="col" width="15%">Issued to Newspapers</th>
