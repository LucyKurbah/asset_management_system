...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Non DIPR Bill Register</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Non DIPR Bill Register Management</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="card">
            <div class="card-body1">
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                            <div class="col-md-3" align=center>
                                <input type="button" class="btn btn-primary btn-get-billing-register" value="Get Register" name="btn-get-billing-register" id="btn-get-billing-register">
                            </div>
                    </div>
                </div>
                <div class="row justify-content-center">
            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100 active" id="user-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-food" type="button" role="tab" aria-controls="home" aria-selected="true"><i class="bi bi-card-list"></i> &nbsp;Non DIPR Billing Register</button>
                </li>
              </ul>
              <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="text-center" scope="col" width="">Size</th>
...
<script src="{{asset('assets/js/modules/reports/nonDIPRbilling_register.js')}}"></script>
@endsection