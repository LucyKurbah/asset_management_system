          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                ...
                <thead>
                  <tr>
                    <th class="text-center" scope="col" width="5%">Emp Code</th>
                ...
                <form id="user-form" method="POST" >
                  ...
                  <input type="hidden" id="id" name="id">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="designation" name="designation" maxlength="10" required>
                        </div>

                        <div class="col-md-6">
                         <label for="division" class="form-label"><b>Division</b></label>
                            <select name="division" id="division" class="form-control" data-placeholder="Select a type">
                        ...
                        <label for="group" class="form-label"><b>Group</b></label>
                            <select name="group" id="group" class="form-control" data-placeholder="Select a type">
...
<script src="{{asset('assets/js/modules/user/user.js')}}"></script>
@endsection