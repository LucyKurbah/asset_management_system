            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100 active" id="user-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-food" type="button" role="tab" aria-controls="home" aria-selected="true"><i class="bi bi-card-list"></i> &nbsp;Purchase</button>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100" id="users-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-foods" type="button" role="tab" aria-controls="profile" aria-selected="false"><i class="ri-file-add-line"></i>  &nbsp; Add/Edit Purchase</button>
                </li>
              </ul>
              <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="text-center" scope="col" width="15%">PO No</th>
                    <th class="text-center" scope="col" width="15%">Installation Date</th>
                    <th class="text-center" scope="col" width="15%">Delivery Date</th>
                    <th class="text-center" scope="col" width="15%">Warranty From</th>
                    <th class="text-center" scope="col" width="15%">Warranty To</th>
                    <th class="text-center" scope="col" width="15%">Purchased By</th>
              ...
              <div class="modal fade" id="disablebackdrop" tabindex="-1" data-bs-backdrop="false">
                ...
                <form id="purchase-form" method="POST" >
                  ...
                  <input type="hidden" id="id" name="id">
                        ...
                        <div class="col-md-6">
                          <label for="po_no" class="form-label"><b>PO No</b></label>
                          <input type="text" class="form-control" id="po_no" name="po_no" required>
                        </div>

                        <div class="col-md-6">
                          <label for="install_date" class="form-label"><b>Installation Date</b></label>
                          <input type="text" class="form-control" id="install_date" name="install_date" maxlength="10" required>
                        </div>

                        <div class="col-md-6">
                          <label for="delivery_date" class="form-label"><b>Delivery Date</b></label>
                          <input type="text" class="form-control" id="delivery_date" name="delivery_date" maxlength="10" required>
                        </div>

                        <div class="col-md-6">
                          <label for="warranty_from" class="form-label"><b>Warranty From</b></label>
                          <input type="text" class="form-control" id="warranty_from" name="warranty_from" maxlength="10" required>
                        </div>

                        <div class="col-md-6">
                          <label for="warranty_to" class="form-label"><b>Warranty To</b></label>
                          <input type="text" class="form-control" id="warranty_to" name="warranty_to" maxlength="10" required>
                        </div>

                        <div class="col-md-6">
                          <label for="purchased_by" class="form-label"><b>Purchased By</b></label>
                          <input type="text" class="form-control" id="purchased_by" name="purchased_by" required>
                        </div>
...
<script src="{{asset('assets/js/modules/admin/purchase.js')}}"></script>
@endsection