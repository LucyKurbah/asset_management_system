            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100 active" id="user-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-food" type="button" role="tab" aria-controls="home" aria-selected="true"><i class="bi bi-card-list"></i> &nbsp;Employee Details List</button>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100" id="users-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-foods" type="button" role="tab" aria-controls="profile" aria-selected="false"><i class="ri-file-add-line"></i>  &nbsp; Add/Edit Employee Details</button>
                </li>
              </ul>
              <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="" scope="col" width="15%">Employee Name</th>
                    <th class="text-center" scope="col" width="15%">Designation</th>
              ...
              <div class="modal fade" id="disablebackdrop" tabindex="-1" data-bs-backdrop="false">
                ...
                <form id="employee-form" method="POST" >
                  ...
                  <input type="hidden" id="id" name="id">
                        ...
                        <div class="col-md-6">
                          <label for="news_type" class="form-label"><b>Employee Name</b></label>
                          <input type="text" class="form-control" id="emp_name" name="emp_name" required>
                        </div>
                        <div class="col-md-6">
                        <!-- <label for="news_type_id" class="form-label"><b>Newspaper Type</b></label>
                            <select name="news_type_id" id="news_type_id" class="form-control" data-placeholder="Select a type">
                                <option value="" disabled selected> --Select a type--</option>
                                @foreach($newspaperTypes as $newspaperType)
                                    <option value="{{ $newspaperType->id }}">{{ $newspaperType->news_type }}</option>
                                @endforeach
                            </select>
                        </div> -->
...
<script src="{{asset('assets/js/modules/admin/employee.js')}}"></script>
@endsection