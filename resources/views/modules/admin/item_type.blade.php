            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100 active" id="user-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-food" type="button" role="tab" aria-controls="home" aria-selected="true"><i class="bi bi-card-list"></i> &nbsp;Item Types List</button>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100" id="users-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-foods" type="button" role="tab" aria-controls="profile" aria-selected="false"><i class="ri-file-add-line"></i>  &nbsp; Add/Edit Item Type</button>
                </li>
              </ul>
              <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                ...
                <div class="alert alert-success alert-block table_msg3" style="display:none;">
                  ...
                  <div class="alert alert-danger table_msg5" style="display:none;">
                        <strong>Oops!</strong> This data cannot be deleted because it is currently in use by another part of the system.          
                  </div>
              ...
              <div class="modal fade" id="disablebackdrop" tabindex="-1" data-bs-backdrop="false">
                ...
                <form id="item_type_form" method="POST" >
                  @csrf
                  <input type="hidden" id="id" name="id">
                        ...
                        <div class="col-md-6">
                          <label for="news_type" class="form-label"><b>Item Type</b></label>
...
<script src="{{asset('assets/js/modules/admin/item_type.js')}}"></script>
@endsection